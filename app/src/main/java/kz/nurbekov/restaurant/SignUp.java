...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btmSignUp = (Button)findViewById(R.id.btnsignup1);
        ...
        btmSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Common.isConnectedToInterner(getBaseContext())) {
                    ...
                    table_user.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.child(edtPhone.getText().toString()).exists()) {
                                mDialog.dismiss();
                                Toast.makeText(SignUp.this, "Номер уже зарегистрирован!", Toast.LENGTH_SHORT).show();
                            } else {
                                mDialog.dismiss();
                    ...
                    Toast.makeText(SignUp.this, "Проверьте соединение!", Toast.LENGTH_SHORT).show();
                    return;}
            }
        });
    }
